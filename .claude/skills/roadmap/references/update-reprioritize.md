# Roadmap update and reprioritization

Use when adjusting an existing roadmap, adding initiatives, or reprioritizing without running the full **strategic planning** workshop (see `strategic-planning.md`).

Update, create, or reprioritize a product roadmap. If a project tracker (Jira, Linear, etc.) is connected, pull current items; otherwise ask the user to paste or describe their roadmap.
