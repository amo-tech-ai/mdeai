...
| Layer | Intent |
|-------|--------|
| **Goal** | Paperclip can call Hermes adapter with parsed, typed responses. |
| **Workflow** | Adapter contract → error handling → tests with stub Hermes. |
| **Proof** | Malformed CLI output yields structured error, not crash. |
| **Gates** | 05C + 05K decisions applied. |
| **Rollout** | Feature-flag adapter in Paperclip. |
