...
| Layer | Intent |
|-------|--------|
| **Goal** | Phase-1 lightweight gates ship before full 05G. |
| **Workflow** | Subset of gates → UI → test. |
| **Proof** | Happy path + deny path covered. |
| **Gates** | Depends on 05K if audit required. |
