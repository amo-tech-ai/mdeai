...
| Layer | Intent |
|-------|--------|
| **Goal** | E5 subtasks have a clear order; 05K unblocks gates/adapters — no circular work. |
| **Workflow** | Follow table order in this file; resolve 05K before 05D/05F/05G hard dependencies. |
| **Proof** | Each sub-prompt merged is traceable to MERM-07; audit log story matches 05K outcome. |
| **Gates** | OpenClaw/Hermes not assumed prod-ready without audits. |
| **Rollout** | Phased: stub audit log acceptable until 05K closed. |
