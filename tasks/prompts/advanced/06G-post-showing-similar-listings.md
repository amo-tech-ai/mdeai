...
| Layer | Intent |
|-------|--------|
| **Goal** | After showing, similar listings suggestion improves conversion. |
| **Workflow** | Trigger on showing complete → query → present cards. |
| **Proof** | Suggestions exclude already-booked; loading state. |
| **Gates** | Listing data from DB; no hallucinated URLs. |
| **Rollout** | A/B optional. |
