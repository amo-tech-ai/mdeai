...
| Layer | Intent |
|-------|--------|
| **Goal** | 50+ eval cases prevent ranking regressions. |
| **Workflow** | Curate cases → automate scoring → CI gate optional. |
| **Proof** | Baseline score tracked in PR. |
| **Gates** | 06A stable enough to compare. |
| **Rollout** | Offline eval first. |
