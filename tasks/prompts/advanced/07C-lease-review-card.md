...
| Layer | Intent |
|-------|--------|
| **Goal** | Lease review UI maps to 07B statuses — renters understand next steps. |
| **Workflow** | States from API → components → empty/error. |
| **Proof** | Each status has copy + CTA. |
| **Gates** | 07B deployed. |
| **Rollout** | Beta with test documents. |
