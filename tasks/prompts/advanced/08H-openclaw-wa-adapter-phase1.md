...
| Layer | Intent |
|-------|--------|
| **Goal** | Echo adapter proves OpenClaw path before full AI. |
| **Workflow** | Echo inbound → outbound → verify latency. |
| **Proof** | No duplicate sends; rate limit OK. |
| **Gates** | Gateway credentials secured. |
| **Rollout** | Lab channel only. |
