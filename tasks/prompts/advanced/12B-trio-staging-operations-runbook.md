...
| Layer | Intent |
|-------|--------|
| **Goal** | Staging runbook lets ops recover from known failure modes. |
| **Workflow** | Commands + contacts + rollback; drill once. |
| **Proof** | Tabletop exercise passes. |
| **Gates** | Secrets in vault. |
| **Rollout** | Ops-only. |
