...
| Layer | Intent |
|-------|--------|
| **Goal** | Feature flags route AI vs fallback safely. |
| **Workflow** | Flag definitions → UI or config → telemetry. |
| **Proof** | Instant rollback via flag. |
| **Gates** | Avoid flag explosion; document matrix. |
