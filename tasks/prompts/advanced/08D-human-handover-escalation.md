...
| Layer | Intent |
|-------|--------|
| **Goal** | Human handover when confidence low — ops inbox or ticket. |
| **Workflow** | Confidence threshold → route → audit. |
| **Proof** | Escalation logged; user sees wait message. |
| **Gates** | Source of confidence documented. |
| **Rollout** | Ops training before prod. |
