...
- [x] Orphan-skip guard in `scripts/verify-edge-functions.sh` proven: empty array OK [x], malformed entry rejected with rc=1 [x], well-formed `name:TASK-ID` accepted [x]
